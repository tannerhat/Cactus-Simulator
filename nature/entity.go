...
func (c *water) AddToBoard(gameBoard GameBoard) {
...
func (c *water) flowTo(gameBoard GameBoard, x int, y int, force bool, dry bool) bool {
...
func (c *water) underPressure(gameBoard GameBoard) bool {
...
func (c *water) Update(gameBoard GameBoard) {
	// try to flow down
